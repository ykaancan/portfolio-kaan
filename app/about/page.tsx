        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                I'm a <strong className="text-foreground">Senior Backend Developer</strong> specializing in building{" "}
                <strong className="text-foreground">production-grade AI systems</strong> and{" "}
                <strong className="text-foreground">distributed architectures</strong>. My work focuses on the
                intersection of traditional backend engineering and modern AI/ML systems.
              </p>
              <p>
                Over the past few years, I've built systems that process financial documents using Large Language
                Models, implemented semantic search with vector databases, and designed distributed file processing
                pipelines handling thousands of files daily. I believe in writing code that is{" "}
                <strong className="text-foreground">maintainable, testable, and performant</strong>.
              </p>
              <p>
                My approach to software engineering is grounded in <strong className="text-foreground">pragmatism</strong>.
                I don't chase trends or over-engineer solutions. Instead, I focus on understanding the problem deeply,
                choosing the right tools, and delivering systems that actually work in production. I'm particularly
                passionate about proper exception handling, transaction management, and building systems that degrade
                gracefully when things go wrong.
              </p>
              <p>
                When it comes to AI integration, I take a{" "}
                <strong className="text-foreground">systematic, metrics-driven approach</strong>. I don't believe in
                "AI magic" - I believe in benchmarking multiple models, measuring precision and recall, and making
                data-driven decisions. My AI classification system didn't achieve 83% precision by luck - it got there
                through careful prompt engineering, two-stage verification, and systematic evaluation.
              </p>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="p-6 rounded-lg border border-primary/20 bg-primary/5">
              <p className="text-muted-foreground leading-relaxed mb-4">
                I'm open to opportunities where I can work on technically
                challenging problems, particularly at the intersection of
                backend engineering and AI systems. I thrive in environments
                that value:
              </p>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Technical excellence</strong> over shipping fast and breaking things
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    <strong className="text-foreground">Production systems</strong> with real users and real
                    consequences
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Mentorship and learning</strong> - I want to work with people
                    better than me
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Clear ownership</strong> - I like owning systems end-to-end
                  </span>
                </li>
              </ul>
            </div>
          ...
          <section className="text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Interested in discussing opportunities, asking about my projects,
