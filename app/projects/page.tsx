...
export const metadata: Metadata = {
  title: 'Projects - Kaan Can Yıldırım',
  description:
      ...
      <Container>
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Detailed case studies of production systems with real metrics, technical decisions, and
            architectural insights. Each project includes specific challenges, solutions, and
            measurable results.
          </p>
        </div>
